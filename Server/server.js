...
// functions
function initDB(con, tables, items) {
    con.connect(function (err) {
        ...
        if (items) {
            ...
            sql = "INSERT INTO goods(name, category_name, price, store, sold, image) VALUES" +
                "('bag1', 'school', 12000, 30, 3, '../Server/Images/1.jpg')," +
                "('bag2', 'school', 15000, 30, 5, '../Server/Images/2.png')," +
                "('bag3', 'party', 40000, 30, 0, '../Server/Images/3.jpg')," +
                "('bag4','uncategorized', 19000, 30, 11, '../Server/Images/4.jpg')";

            con.query(sql, function (err) {
                    if (err) throw err;
                    console.log("New goods added.");
                }
            );
        }
    });
