...
function setLeftValue() {
    ...
    document.getElementById("input-left-output").innerHTML = document.getElementById("input-left").value;
}
...
function setRightValue() {
    ...
    document.getElementById("input-right-output").innerHTML = document.getElementById("input-right").value;
}
